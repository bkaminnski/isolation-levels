...
public class WriteSkewScenarioVersionedOptimisticLockTest extends WriteSkewScenariosTest {

    @Autowired
    private WriteSkewScenariosSetup scenarioSetup;
    @Autowired
    private WriteSkewScenarioVersionedOptimisticLock scenario;
    @Autowired
    ...
    @Test
    public void writeSkewScenarioVersionedOptimisticLockReadCommitted_invariantViolated() throws ExecutionException, InterruptedException {
    ...
    @Test
    public void writeSkewScenarioVersionedOptimisticLockRepeatableRead_invariantViolated() throws ExecutionException, InterruptedException {
        WriteSkewFlowControl flowControl = new WriteSkewFlowControl();
