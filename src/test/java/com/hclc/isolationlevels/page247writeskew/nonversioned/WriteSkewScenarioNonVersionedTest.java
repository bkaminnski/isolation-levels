...
public class WriteSkewScenarioNonVersionedTest extends WriteSkewScenariosTest {

    @Autowired
    private WriteSkewScenariosSetup scenarioSetup;
    @Autowired
    private WriteSkewScenarioNonVersioned scenario;
    ...
    @Test
    public void writeSkewScenarioNonVersionedReadCommitted_invariantViolated() throws ExecutionException, InterruptedException {
    ...
    @Test
    public void writeSkewScenarioNonVersionedRepeatableRead_invariantViolated() throws ExecutionException, InterruptedException {
        WriteSkewFlowControl flowControl = new WriteSkewFlowControl();
